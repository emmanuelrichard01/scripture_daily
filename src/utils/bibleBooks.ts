...
export const getBookId = (bookName: string): number | null => {
  // Normalize the book name (e.g., handle "Song of Songs" vs "Song of Solomon")
  let normalized = bookName;
  if (normalized === "Song of Songs") normalized = "Song of Solomon";
...
export const AVAILABLE_VERSIONS = [
  ...
  { id: "LSB", name: "Legacy Standard Bible (LSB)" },
